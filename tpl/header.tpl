	...
	<table border="0">
		<tr>
			<td>
				...
				<a href="?action=home"><img  border="0" alt="Home" title="Home" height="50" src="images/home.jpg" /></a>
...
<div class="topPane">
	<table border="0" width="100%">
		<tr>
			<td>
				<form method="post" id="switchUserForm" action="">
					<table border="0">
						<tr>
							<td>
			...
			{if $user}
				<td width="20"></td>
				<td>
					<form method="post" id="changeAvatarForm" action="">
						<table border="0">
							<tr>
								<td>
			...
			<td width="20"></td>
			<td>
				<a href="?action=home"><img border="0" width="16" height="16" src="images/home.png" alt="Home" title="Home" /></a>
			</td>
			<td width="20"></td>
			<td>
			...
			<td width="20"></td>
			<td>
				<a href="?action=help">{if ! $user}HELP {/if}<img border="0" width="16" height="16" src="images/help.png" alt="Help" title="Help" /></a>
			</td>
		</tr>
	</table>
</div>
